...
@Component({
    templateUrl: "./trainings-edit-modal.component.html",
    styleUrls: ['./trainings-edit-modal.component.scss']
})
export class TrainingsEditModalComponent implements OnInit {
    ...
    savedToastr(){
        this.toastr.success("Vježba ažurirana",'Uspjeh!')
    }
    failedToastr(){
