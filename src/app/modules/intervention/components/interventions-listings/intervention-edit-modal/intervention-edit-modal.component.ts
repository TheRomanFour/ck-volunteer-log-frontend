...
@Component({
    templateUrl: "./intervention-edit-modal.component.html",
    styleUrls: ['./intervention-edit-modal.component.scss']
})
export class InterventionEditModalComponent implements OnInit {
